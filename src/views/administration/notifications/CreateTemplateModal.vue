<template>
  <b-modal id="createTemplateModal" size="md" hide-header-close no-stacking :title="$t('admin.create_template')">
    ...
    label-class="optional">
      <input type="checkbox" id="input-6" v-model="schedulednotification" @click="expandView()"/>
    </b-form-group>
    <b-form-group v-if="schedulednotification"
      id="fieldset-7"
      :label="this.$t('admin.cron')"
      label-for="input-7"
      label-class="required">
      <b-form-textarea id="input-7" v-model="cronExpression" class="required" required trim />
    </b-form-group>
    <b-form-group v-if="schedulednotification"
      id="fieldset-8"
      ...
      label-for="input-8"
      label-class="required">
      <b-form-textarea id="input-8" v-model="emailDestinations" class="required" required trim />
    </b-form-group>
    <b-form-group v-if="schedulednotification"
      id="fieldset-9"
      ...
      label-for="input-9"
      label-class="required">
      <b-form-textarea id="input-9" v-model="projectId" class="required" required trim />
    </b-form-group>
